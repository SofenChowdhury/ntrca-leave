          ...
          response.data.data.map((sales) => {
            sales.return_items.map((item) => {
              ...
              temp = {
                ...
                "Challan No": sales.sales ? sales.sales.sales_no : sales.challan_no,
                "Challan Date": sales.sales ? sales.sales.challan_date : sales.challan_date,
                "Title" : item.info?.title,
                "Challan Value" : sales.sales ? getPrice(sales.sales, item.product_id) : item.challan_item_value,
                "Challan Qty" : sales.sales ? getQty(sales.sales, item.product_id) : item.challan_item_qty,
                "Challan VAT" : sales.sales ? getVat(sales.sales, item.product_id) : item.challan_item_vat,
